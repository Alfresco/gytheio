...
![Example architecture of a simple image transform node](https://github.com/Alfresco/gytheio/blob/master/doc/resources/images/gytheio-architecture-simple-transform-node.png?raw=true "Example architecture of a simple image transform node")
