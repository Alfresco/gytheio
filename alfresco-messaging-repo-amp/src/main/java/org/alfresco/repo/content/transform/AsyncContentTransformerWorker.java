...
/**
 * Asynchronous capable content transformer.
 */
public interface AsyncContentTransformerWorker extends ContentTransformerWorker
{

    public String transform(ContentReader reader, ContentWriter writer, 
            TransformationOptions options, boolean executeAsynchronously) throws ContentIOException;
