...
import org.alfresco.content.hash.ContentHashNodeWorker;
import org.alfresco.content.hash.HashRequest;
import org.alfresco.content.hash.javase.JavaSeContentHashNodeWorker;
import org.junit.Before;
import org.junit.Test;

public class JavaSeContentHashNodeWorkerTest
{
    ...
    private ContentHashNodeWorker worker;
    ...
    {
        testHash(HashRequest.HASH_ALGORITHM_MD5, EXPECTED_VALUE_MD5);
    }
    
    @Test
    public void testSha256() throws Exception
    {
        testHash(HashRequest.HASH_ALGORITHM_SHA_256, EXPECTED_VALUE_SHA_256);
    }
    
    @Test
    public void testSha512() throws Exception
    {
        testHash(HashRequest.HASH_ALGORITHM_SHA_512, EXPECTED_VALUE_SHA_512);
    }
