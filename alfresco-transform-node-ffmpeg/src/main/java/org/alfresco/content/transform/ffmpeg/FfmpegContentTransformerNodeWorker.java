...
import org.alfresco.content.transform.AbstractContentTransformerWorker;
 ...
 * @author Ray Gauss II
 */
public class FfmpegContentTransformerNodeWorker extends AbstractContentTransformerWorker
{
    private static final Log logger = LogFactory.getLog(FfmpegContentTransformerNodeWorker.class);
