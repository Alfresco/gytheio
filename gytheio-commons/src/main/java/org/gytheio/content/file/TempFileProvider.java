...
public class TempFileProvider
{
    ...
    public static File getSystemTempDir()
    {
        ...
        {
            throw new GytheioRuntimeException("System property not available: " + SYSTEM_KEY_TEMP_DIR);
        }
    ...
    public static File getTempDir(String dirName)
    {
        ...
        else
        {
            ...
            if (!tempDir.mkdirs())
            {
                throw new GytheioRuntimeException("Failed to create temp directory: " + tempDir);
            }
            if (logger.isDebugEnabled())
            {
    ...
    public static File createTempFile(String prefix, String suffix, File directory)
    {
        ...
        {
            throw new GytheioRuntimeException("Failed to created temp file: \n" +
                    "   prefix: " + prefix + "\n"
                    + "   suffix: " + suffix + "\n" +
                    "   directory: " + directory,
                    e);
    ...
    public static File getLongLifeTempDir(String key)
    {
        ...
        throw new GytheioRuntimeException("Failed to create temp directory: " + longLifeDir);
    }
